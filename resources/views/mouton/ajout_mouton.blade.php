    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="page-header">
                <h1>Xar-Bi</h1>
                <small>Ajout / Mouton</small>
            </div>
            <div class="scrolling-text">
                <h2>Bienvenue {{ Auth::user()->prenom }} {{ Auth::user()->nom}} Voici La Page Pour Ajouter Un Mouton</h2>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">AJOUT MOUTON</div>

                        <div class="card-body">
                            <form method="POST" action="{{ route('mouton.ajout') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('prix') is-invalid @enderror" id="prix" name="prix" required>

                                </div>
                                <div class="form-group">
                                    <label for="genealogie">Généalogie</label>
                                    <input type="text" class="form-control @error('genealogie') is-invalid @enderror" id="genealogie" name="genealogie" required>
